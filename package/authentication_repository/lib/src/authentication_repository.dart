...
class AuthenticationRepository {
  ...
  Future<void> connexionAvecEmailEtMotDePasse({
    required String email,
    required String password,
  }) async {
    try {
  ...
  Future<void> connexionAnonyme() async {
    try {
...
class FakeAuthenticationRepository implements AuthenticationRepository {
  ...
  Future<void> connexionAvecEmailEtMotDePasse({
    ...
    try {
      ...
      userConnecter = userCredential.user?.toUser;
    } on firebase_auth.FirebaseAuthException catch (e) {
      throw SignUpWithEmailAndPasswordFailure.fromCode(e.code);
    } catch (_) {
      throw const SignUpWithEmailAndPasswordFailure();
  ...
  Future<void> modifieMotDePasse(
      {required String motDePasseActuel,
      required String nouveauMotDePasse}) async {}
}
